...
1. Abre el panel de **Copilot Chat** y cambia a **Plan Agent**.
   ...
   <img width="350" alt="imagen" src="https://github.com/RARB54X/github-copilot-primeros-pasos3/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. Revisa el plan propuesto y, cuando estés conforme con él, haz clic en **Start implementation** para entregarlo a **Agent Mode**.
   ...
   <img width="350" alt="imagen" src="https://github.com/RARB54X/github-copilot-primeros-pasos3/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
